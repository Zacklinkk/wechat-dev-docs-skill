...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/wx.saveFileToDisk.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/wx.openDocument.html
...
|  | showMenu | boolean | false | 否 | 是否显示右上角菜单 | [2.11.0](../../framework/compatibility.html) |
|  | fileType | string |  | 否 | 文件类型，指定文件类型打开文件 | [1.4.0](../../framework/compatibility.html) |
|  | | 合法值 | 说明 | | --- | --- | | doc | doc 格式 | | docx | docx 格式 | | xls | xls 格式 | | xlsx | xlsx 格式 | | ppt | ppt 格式 | | pptx | pptx 格式 | | pdf | pdf 格式 | | | | | | |
|  | success | function |  | 否 | 接口调用成功的回调函数 |  |
|  | fail | function |  | 否 | 接口调用失败的回调函数 |  |
|  | complete | function |  | 否 | 接口调用结束的回调函数（调用成功、失败都会执行） |  |
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/wx.getFileSystemManager.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileStats.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.access.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.accessSync.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.appendFile.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.appendFileSync.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.close.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.closeSync.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.copyFile.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.copyFileSync.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.fstat.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.fstatSync.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.ftruncate.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.ftruncateSync.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.getFileInfo.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.getSavedFileList.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.mkdir.html
...
| recursive | boolean | false | 否 | 是否在递归创建该目录的上级目录后再创建该目录。如果对应的上级目录已经存在，则不创建该上级目录。如 dirPath 为 a/b/c/d 且 recursive 为 true，将创建 a 目录，再在 a 目录下创建 b 目录，以此类推直至创建 a/b/c 目录下的 d 目录。 | [2.3.0](../../framework/compatibility.html) |
| success | function |  | 否 | 接口调用成功的回调函数 |  |
| fail | function |  | 否 | 接口调用失败的回调函数 |  |
| complete | function |  | 否 | 接口调用结束的回调函数（调用成功、失败都会执行） |  |
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.mkdirSync.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.open.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.openSync.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.read.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.readCompressedFile.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.readCompressedFileSync.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.readdir.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.readdirSync.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.readFile.html
...
|  | | 合法值 | 说明 | | --- | --- | | ascii |  | | base64 |  | | binary |  | | hex |  | | ucs2 | 以小端序读取 | | ucs-2 | 以小端序读取 | | utf16le | 以小端序读取 | | utf-16le | 以小端序读取 | | utf-8 |  | | utf8 |  | | latin1 |  | | | | | | |
|  | position | number |  | 否 | 从文件指定位置开始读，如果不指定，则从文件头开始读。读取的范围应该是左闭右开区间 [position, position+length)。有效范围：[0, fileLength - 1]。单位：byte | [2.10.0](../../framework/compatibility.html) |
|  | length | number |  | 否 | 指定文件的长度，如果不指定，则读到文件末尾。有效范围：[1, fileLength]。单位：byte | [2.10.0](../../framework/compatibility.html) |
|  | success | function |  | 否 | 接口调用成功的回调函数 |  |
|  | fail | function |  | 否 | 接口调用失败的回调函数 |  |
|  | complete | function |  | 否 | 接口调用结束的回调函数（调用成功、失败都会执行） |  |
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.readFileSync.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.readSync.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.readZipEntry.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.removeSavedFile.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.rename.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.renameSync.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.rmdir.html
...
| recursive | boolean | false | 否 | 是否递归删除目录。如果为 true，则删除该目录和该目录下的所有子目录以及文件。 | [2.3.0](../../framework/compatibility.html) |
| success | function |  | 否 | 接口调用成功的回调函数 |  |
| fail | function |  | 否 | 接口调用失败的回调函数 |  |
| complete | function |  | 否 | 接口调用结束的回调函数（调用成功、失败都会执行） |  |
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.rmdirSync.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.saveFile.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.saveFileSync.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.stat.html
...
| recursive | boolean | false | 否 | 是否递归获取目录下的每个文件的 Stats 信息 | [2.3.0](../../framework/compatibility.html) |
| success | function |  | 否 | 接口调用成功的回调函数 |  |
| fail | function |  | 否 | 接口调用失败的回调函数 |  |
| complete | function |  | 否 | 接口调用结束的回调函数（调用成功、失败都会执行） |  |
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.statSync.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.truncate.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.truncateSync.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.unlink.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.unlinkSync.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.unzip.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.write.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.writeFile.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.writeFileSync.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/FileSystemManager.writeSync.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/ReadResult.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/Stats.html

---

### boolean Stats.isDirectory()

小程序插件：支持，需要小程序基础库版本不低于2.19.2

官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/Stats.isDirectory.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/Stats.isFile.html
...
官方 / Source: https://developers.weixin.qq.com/miniprogram/dev/api/file/WriteResult.html
